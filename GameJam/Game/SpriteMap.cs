...
namespace GameJam.Game
{
    public class SpriteMap
    {
        ...
        internal SpriteMap()
        {
            ...
            tileObjects.Add('1', () => { return new TileBehaviour(true, false, true); });
            tileObjects.Add('2', () => { return new TileBehaviour(true, false, true); });
            tileObjects.Add('3', () => { return new TileBehaviour(true, false, true); });
